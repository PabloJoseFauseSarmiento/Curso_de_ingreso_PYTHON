...
class App(customtkinter.CTk):
    ...
    def btn_restar_on_click(self):
        ...
        operador_b = int(self.txt_operador_b.get())
        resultado = str(operador_a - operador_b)
        alert("Este es tu resultado", "El resultado de la resta es: " + resultado)

    def btn_multiplicar_on_click(self):
        operador_a = int(self.txt_operador_a.get())
        operador_b = int(self.txt_operador_b.get())
        resultado = str(operador_a * operador_b)
        alert("Este es tu resultado", "El resultado de la multiplicacion es: " + resultado)

    def btn_dividir_on_click(self):
        operador_a = int(self.txt_operador_a.get())
        operador_b = int(self.txt_operador_b.get())
        resultado = str(operador_a / operador_b)
        alert("Este es tu resultado", "El resultado de la division es: " + resultado)
