...
class App(customtkinter.CTk):
    ...
    def btn_mostrar_on_click(self):
        ...
        if Altura > 1.79:
            alert("Determinacion de altura","Usted es pivot, ya que tiene " + str(Altura) + " metros")
        
        else:
            alert("Determinacion de altura", "Usted no es pivot, tiene " + str(Altura) + " metros, y el minimo es 1.80")
